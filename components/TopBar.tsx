  ...
  return (
    <header className="h-12 flex-shrink-0 flex items-center justify-between px-5 border-b border-white/5 bg-[#0a0a0f]/60 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-2">
        {/* Community button */}
        <motion.a
          href="https://x.com/i/communities/2039409482170773803"
          target="_blank"
          rel="noopener noreferrer"
          whileHover={{ scale: 1.03 }}
          whileTap={{ scale: 0.97 }}
          className="relative flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-semibold overflow-hidden group transition-all duration-200"
          style={{
        ...
        >
          ...
          />
          {/* X logo */}
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 relative flex-shrink-0">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.261 5.628L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
          </svg>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-full border border-white/8 bg-white/3 hover:bg-white/6 hover:border-white/15 transition-all duration-200 text-white/35 hover:text-white/65"
        >
